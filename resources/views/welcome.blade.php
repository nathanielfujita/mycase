...
<html lang="ja">
 <head>
        ...
        <link rel="stylesheet" href="MyCaseTest.css">
        ...
        <header>
            ...
            <div class="sidebar">
            　
            　 <div class = "logo"><img src="MyCase-logo.jpg" alt="My Case"></div>
             　    <ul>
   ...
   <div id="1st-line">
    ...
    <div id="3rd-line">
        <div class = "row">
            ...
            <div class="pictures col-sm-5">
                <div class>
                <img src="hawaii2.jpg" alt="海の写真"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="4th-line">
        <div class ="row">
            <div class="pictures col-sm-5 col-sm-offset-1">
                <div class>
                <img src="hawaii3.jpg" alt="海の写真">
                </div>
            </div>
        
            <div class="powerpoint col-sm-5">
                <div class>
                <img src="MyCase3.PNG" alt="パワーポイント"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="5th-line">
        <div class = "row">
            <div class="powerpoint col-sm-5 col-sm-offset-1">
                <div class>
                <img src="MyCase4.PNG" alt="パワーポイント">
                </div>
            </div>
            ...
            <div class="pictures col-sm-5">
                <div class>
                <img src="beach.jpg" alt="ビーチの写真"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="6th-line">
        <div class ="row">
            ...
            <div class="powerpoint col-sm-5">
                <div class>
                <img src="MyCase5.PNG" alt="パワーポイント"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="7th-line">
        <div class ="row">
            <div class="powerpoint col-sm-5 col-sm-offset-1">
                <div class>
                <img src="MyCase6.PNG" alt="パワーポイント">
                </div>
            </div>
    
            <div class="pictures col-sm-5">
                <div class>
                <img src="travel.jpg" alt="海の写真"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="ryoukin">
        <div class="powerpoint">
            <center><img src="Plan.jpg" alt="パワーポイント"></div></center>
    
        <div class="powerpoint">
            <center><img src="Plan1.jpg" alt="パワーポイント"></div></p></center>
    </div>    
